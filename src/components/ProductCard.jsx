...
const ProductCard = ({ product }) => {
    ...
    product.price * (1 - product.discount) : product.price; // Calcula el precio final con descuento, si es que lo tiene. En caso contrario, usa el precio normal.
    ...
    return (
        <div className="col">
            <div className="card h-100 product-card-enhanced">
                ...
                <div className="product-card-body"> {/* clase para el cuerpo */}
                    <h5 className="product-card-title">{product.name}</h5> {/* clase para el título */}
